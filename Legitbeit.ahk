...
Gui, Key:Add, Text, x12 y8 w180 h20 +Center, Legitbeit - License System
Gui, Key:Show, w204 h117, Legitbeit
return
CheckKey:
...
Gui, Home:Add, Text, x252 y40 w30 h20 , 0.0.1
Gui, Home:Add, Text, x182 y40 w60 h20 , [0.3.7] (R1)
Gui, Home:Font, s15, Verdana
Gui, Home:Add, Text, x12 y10 w270 h30 +Center, Legitbeit
Gui, Home:Show, w294 h155, Legitbeit
IniRead, FW_Menu_Y, Config.ini, Overlay, FW_Menu_Y, 150
Loop,
{
...
SetTimer, MinusHPShow, 250
SetTimer, MinusARShow, 250
...
If(HP_Schaden > 10 and HP_Schaden < 200)
{
...
If(AR_Schaden > 10 and AR_Schaden < 200)
{
...
F11::
Insert::
FW_Menu("N", "Legitbeit", "{FE2E64}[Legit Hacks 4 HuanZ],- Health Hack,- Armor Hack,- Infinity Run,- Infinity Nitro,- No Spread,- Nametag Hack,")
return
FW_Menu_Label_Legitbeit_1:
FW_Menu("N", "Legit Hacks", "Ist nur eine Kategorie...`nMenÃ¼ neu Ã¶ffnen!")
return
FW_Menu_Label_Legitbeit_2:
FW_Menu("N", "Health", "error")
FW_Menu("N", "Health", "+100,+75,+50,+25,-25,-50,-75,-100")
return
FW_Menu_Label_Legitbeit_3:
FW_Menu("N", "Armor", "error")
FW_Menu("N", "Armor", "+100,+75,+50,+25,-25,-50,-75,-100")
return
FW_Menu_Label_Legitbeit_4:
FW_Menu("N", "Infinity_run", "error")
FW_Menu("N", "Infinity_run", "ON,OFF")
return
FW_Menu_Label_Legitbeit_5:
FW_Menu("N", "Infinity_Nitro", "error")
FW_Menu("N", "Infinity_Nitro", "ON,OFF")
return
FW_Menu_Label_Legitbeit_6:
FW_Menu("N", "No_Spread", "error")
FW_Menu("N", "No_Spread", "ON,OFF")
return
FW_Menu_Label_Legitbeit_7:
...
if(premium = 1)
{
AddChatMessage("{0174DF}[Legitbeit]{FFFFFF}: No_Spread wurde {3ADF00}Aktiviert{FFFFFF}.")
executeCheat("norecoil")
}
else
{
AddChatMessage("{0174DF}[Legitbeit]{FFFFFF}: Diese Funktion ist nur fÃ¼r {BF00FF}Premium{FFFFFF} nutzer verfÃ¼gbar.")
}
return
FW_Menu_Label_No_Spread_2:
if(premium = 1)
{
AddChatMessage("{0174DF}[Legitbeit]{FFFFFF}: No_Spread wurde {FE2E64}Deaktiviert{FFFFFF}.")
executeCheat("norecoil")
}
else
{
...
if(premium = 1)
{
AddChatMessage("{0174DF}[Legitbeit]{FFFFFF}: Nametag wurde {3ADF00}Aktiviert{FFFFFF}.")
executeCheat("hp")
executeCheat("name")
executeCheat("hpr")
executeCheat("namer")
...
if(premium = 1)
{
AddChatMessage("{0174DF}[Legitbeit]{FFFFFF}: Nametag wurde {FE2E64}Deaktiviert{FFFFFF}.")
executeCheat("hp")
executeCheat("name")
executeCheat("hpr")
executeCheat("namer")
...
AddChatMessage("{0174DF}[Legitbeit]{FFFFFF}: Infinity_run wurde {3ADF00}Aktiviert{FFFFFF}.")
Infinityrun(1)
return
FW_Menu_Label_Infinity_run_2:
AddChatMessage("{0174DF}[Legitbeit]{FFFFFF}: Infinity_run wurde {FE2E64}Deaktiviert{FFFFFF}.")
Infinityrun(0)
return
FW_Menu_Label_Infinity_Nitro_1:
if(premium = 1)
{
AddChatMessage("{0174DF}[Legitbeit]{FFFFFF}: Infinity_Nitro wurde {3ADF00}Aktiviert{FFFFFF}.")
InfinityNitro(1)
}
else
{
...
if(premium = 1)
{
AddChatMessage("{0174DF}[Legitbeit]{FFFFFF}: Infinity_Nitro wurde {FE2E64}Deaktiviert{FFFFFF}.")
InfinityNitro(0)
}
else
{
...
if(premium = 1)
{
AddChatMessage("{0174DF}[Legitbeit]{FFFFFF}: PlayerArmor wurde auf {BF00FF}+ 100{FFFFFF} gesetzt.")
...
if(premium = 1)
{
AddChatMessage("{0174DF}[Legitbeit]{FFFFFF}: PlayerArmor wurde auf {BF00FF}+ 75{FFFFFF} gesetzt.")
...
if(premium = 1)
{
AddChatMessage("{0174DF}[Legitbeit]{FFFFFF}: PlayerArmor wurde auf {BF00FF}+ 50{FFFFFF} gesetzt.")
...
if(premium = 1)
{
AddChatMessage("{0174DF}[Legitbeit]{FFFFFF}: PlayerArmor wurde auf {BF00FF}+ 25{FFFFFF} gesetzt.")
...
AddChatMessage("{0174DF}[Legitbeit]{FFFFFF}: PlayerArmor wurde auf {BF00FF}+ 25{FFFFFF} gesetzt.")
SetPlayerArmor(GetPlayerArmor() + 25)
AddChatMessage("{0174DF}[Legitbeit]{FFFFFF}: Dies kannst du jede 3 Sekunden da du kein {BF00FF}Premium{FFFFFF} nutzer bist..")
sleep 3000
}
return
...
if(premium = 1)
{
AddChatMessage("{0174DF}[Legitbeit]{FFFFFF}: PlayerHealth wurde auf {BF00FF}+ 100{FFFFFF} gesetzt.")
...
if(premium = 1)
{
AddChatMessage("{0174DF}[Legitbeit]{FFFFFF}: PlayerHealth wurde auf {BF00FF}+ 75{FFFFFF} gesetzt.")
...
if(premium = 1)
{
AddChatMessage("{0174DF}[Legitbeit]{FFFFFF}: PlayerHealth wurde auf {BF00FF}+ 50{FFFFFF} gesetzt.")
...
if(premium = 1)
{
AddChatMessage("{0174DF}[Legitbeit]{FFFFFF}: PlayerHealth wurde auf {BF00FF}+ 25{FFFFFF} gesetzt.")
...
FW_Menu_Text_Name := TextCreate("Calibri", 7, false, false, 0, 0, 0xFFFFFFFF, "Legit Version", false, false)
